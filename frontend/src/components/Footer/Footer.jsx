...
export const FooterBar = () => {;
  ...
  return (
    <footer
      className={`w-full text-amber-100 py-4 flex flex-col bg-transparent backdrop-filter backdrop-blur-2xl items-center justify-center`}
    >
      <div className="text-sm mt-1 opacity-70 lato-black">
        © {new Date().getFullYear()} Kavya Agar. Built with ❤️ and lots of coffee.
      </div>
