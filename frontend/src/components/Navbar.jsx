...
export default function Navbar() {
    ...
    return (
        <nav className="custom-navbar flex items-center justify-between px-8 py-4 w-full top-0 left-0 fixed z-50 bg-transparent backdrop-filter backdrop-blur-2xl">
            {/* Logo and Name */}
